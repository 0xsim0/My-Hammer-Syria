        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <Hammer className="h-6 w-6 text-primary-600" aria-hidden="true" />
          ...
          <div className="flex gap-3">
            <a
              href="#"
              aria-label="Facebook"
              className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 text-gray-600 transition-colors hover:bg-primary-100 hover:text-primary-600"
            >
